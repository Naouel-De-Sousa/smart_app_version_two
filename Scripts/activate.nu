...
let virtual-env = "C:\Users\utilisateur\.virtualenvs\application_smart_lander-MUi8NiI4"
let bin = "Scripts"
let path-sep = ";"
...
let virtual_prompt = (if ("application_smart_lander" != "") {
    "(application_smart_lander) "
} {
...
alias deactivate = source "C:\Users\utilisateur\.virtualenvs\application_smart_lander-MUi8NiI4\Scripts\deactivate.nu"
